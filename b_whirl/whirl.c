...
static const ConfigDoc doc[] = {
  ...
  {"whirl.horn.breakpos",      CFG_DOUBLE,  "0",        "horn stop position 0: free, 0.0-1.0 clockwise position where to stop. 1.0:front-center", "deg", 0.0, 1.0, .025},
  ...
  {"whirl.drum.breakpos",      CFG_DOUBLE,  "0",        "drum stop position 0: free, 0.0-1.0 clockwise position where to stop. 1.0:front-center", "deg", 0.0, 1.0, .025},
  ...
  {"whirl.mic.distance",       CFG_DOUBLE,  "42.0",     "Distance from mic to origin in centimeters", "cm"},
  {"whirl.horn.level",         CFG_DECIBEL, "0.7",      "horn wet-signal volume", "dB", 0, 1.0, 2.0},
  {"whirl.horn.leak",          CFG_DECIBEL, "0.15",     "horh dry-signal leak", "dB", 0, 1.0, 2.0},
